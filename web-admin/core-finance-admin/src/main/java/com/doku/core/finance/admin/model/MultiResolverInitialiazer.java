package com.doku.core.finance.admin.model;
...
public class MultiResolverInitialiazer extends AbstractAnnotationConfigDispatcherServletInitializer {
	@Override
	protected Class<?>[] getRootConfigClasses() {
		return new Class[] { MultiResolverInitialiazer.class };
	}
